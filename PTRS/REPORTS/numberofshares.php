      ...
      <section class="content">
        ...
        <div class="box">
          <div class="box-header with-border">
            <h4 class="box-title">Paid Up Shares List</h4>
          ...
          <div class="box-footer">
            <div class="col-xs-6">          
              <button type="button" class="btn btn-success"  id="pus" name="pus"><i class="fa fa-list"></i>  Generate </button>
            </div>
          </div>
        </div>  
        <div id="details"></div>
