      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li><a href="cds-css-landing.php"><i class="fa fa-dashboard"></i> Home</a></li>
           <li><a href="#">Netted Position</a></li>      
        </ol>
      </section>
      <section class="content">
        ...
        <div class="box">
          <div class="box-header with-border">
            <h4 class="box-title">Clearing and Settlement</h4>
          ...
          <div class="box-footer">
            <div class="col-lg-6 col-md-6">
              <button type="button" class="btn btn-success" id="detailNet" name="detailNet" value=""><i class="fa fa-list"></i>  Generate </button>
            </div>
          </div>
          <div id="details"></div>
        </div>
...
<script type="text/javascript">
  $('#detailNet').click( function() {
    ...
    var net_report = 'net_report';
    $.ajax({
      type: "POST",
      url: "load.php",
      data: 'toDate1='+toDate1 +'&fromDate1='+fromDate1 +'&net_report='+ net_report,
      dataType: "html",
