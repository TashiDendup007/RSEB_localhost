      ...
      <section class="content">
        ...
        <div class="box">
          <div class="box-header with-border">
            <h4 class="box-title">Pledge Audit</h4>
          ...
          <div class="box-footer">
            <div class="col-lg-6 col-md-6">
              <button type="button"  class="btn btn-success" id="pledge__audit" name="pledge__audit" value=""><i class="fa fa-list"></i>  Generate </button>
            </div>
          </div>
         </div>
        <div id="details"></div>         
...
<script type="text/javascript">
  $('#pledge__audit').click(function(){
    showLoading();
    var toDate = $("#to_date").val();
    var fromDate = $("#from_date").val();
    var op = 'get_no_pledge_audit';
    $.ajax({
      type: "POST",
      url: "loadReport.php",
      data: 'toDate='+toDate +'&fromDate='+fromDate +'&get_no_pledge_audit='+ op,
      dataType: "html",
