    ...
    <section class="content">
      <div class="box">
        <div class="box-header with-border">
          <h4 class="box-title">PTRS Dashboard</h4>
              ...
              <div class="row">
                ...
                <div class="col-lg-2 col-xs-4">
                  <div class="small-box bg-green">
                    ...
                    <a href="https://rsebl.org.bt/online/market_price.php" class="small-box-footer" target="_blank">Click Here <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                ...
                <div class="col-lg-2 col-xs-4">
                  <div class="small-box bg-blue">
                    ...
                    <a href="../REPORTS/highlights.php" class="small-box-footer">Click Here <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>
