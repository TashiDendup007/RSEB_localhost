    ...
    <body onload="window.print();">
      <div class="wrapper">
        <section class="invoice" style="background:rgb(248, 249, 249);">
            ...
            <div class="col-lg-12">
              <div class="page-header">
                ...
                <b style="font-size: 110%;">ROYAL SECURITIES EXCHANGE OF BHUTAN<b>
                 ...
                 <div class="lead" style="font-size: 40%;  margin-top:-25px;">From Date :<b>'.$fromDate.'</b>&nbsp;To Date :<b>'.$toDate.'</b><br>
          ...
          $query = $dbh->prepare('SELECT a.lot_size_execute, a.order_exe_price, a.order_date, a.side, b.symbol, a.dirty_price, a.accur_rate, a.ytm 
