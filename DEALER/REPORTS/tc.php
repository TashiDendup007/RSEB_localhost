      ...
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          <li><a href="cds-css-landing.php"><i class="fa fa-dashboard"></i> Home</a></li>
           <li><a href="#">Trade Confirmation</a></li>      
        </ol>
      </section>
      <section class="content"><div class="modal fade" id="myModal" role="dialog"></div>
        <div class="box">
          <div class="box-header with-border text-center">
            <h4 class="box-title"><strong>Trade Confirmation</strong></h4>
          ...
          <div class="box-body">
            <div class="col-lg-4 col-md-4 col-sm-12">
              ...
              <div class="input-group date">
                ...
                <input type="text" class="form-control pull-right" maxlength="10" name="cdcode" id="cdcode" value="<?php echo $cdcode_session; ?>" readonly required>
              </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              ...
              <div class="input-group date">
                ...
                <input type="date" class="form-control pull-right" name="from_date1" id="from_date1" onChange="return check_date_fun();" required>
              </div>
          ...
          <div class="box-footer">
            <div class="col-lg-4 col-md-4">          
              <button type="button" class="btn btn-success" id="tradeConfirmation" name="tradeConfirmation"><i class="fa fa-bars"></i> Generate </button>
            </div>
          </div>
...
<script type="text/javascript">
  $('#tradeConfirmation').click( function() {
    ...
    var operation = 'trade_confirmation';
