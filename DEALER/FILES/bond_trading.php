<?php 
  ...
  $stmt = $dbh->prepare("SELECT a.f_name, a.l_name, a.title, a.address, a.cd_code, u.participant_code FROM client_account a INNER JOIN users u ON a.ID = u.cid WHERE u.username = ?;");
              ...
              <form action="" method="POST">
                <div class="row form-horizontal">
                  <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <input type="text" name="cd_code" id="cd_code" class="form-control" value="<?php echo $result['cd_code'] ?? ''; ?>" maxlength="10" required readonly>
                    <input type="hidden" name="order_type" id="order_type" class="form-control" value="RFQ">
                  </div>

                  <div class="col-lg-8 col-md-8 col-sm-12">
                    <label>Client Details</label>
                    <input type="text" name="cd_dtls" id="cd_dtls" class="form-control" value="<?php echo $result['f_name'] ?? ''; ?>" readonly>
                  </div>
