...
<div class="container mt-5">
    ...
    <div class="row">
        <!-- First Form: Order No -->
        <h2 class="text-center">Check Transaction of GMC</h2>
...
<script type="text/javascript">
	$("#submit_transaction_id").click( function() {
		...
		const operation = 'submit__successful__transaction';
		if (order_no_bfs == '') {
			...
			$.ajax({
	            ...
	            data: {
	                ...
	                submit__successful__transaction: operation
	            },
	            dataType: 'html',
	...
	$("#submit_orderno_id").click( function() {
		...
		const operation = 'get__bond__dtls';
