      ...
      <section class="content">
        ...
        <div class="box">
          <div class="box-header with-border">
            <h4 class="box-title"><strong>Bond Executed Report</strong></h4>
          ...
          <div class="box-footer">
            <div class="col-lg-6 col-md-6">          
              <button type="button" class="btn btn-success" id="tradeDetail" name="tradeDetail"><i class="fa fa-database"></i>  Generate</button>
            </div>
          </div>
          <div id="details"></div>
        </div>    
...
<script type="text/javascript">
  $('#tradeDetail').click(function() {
      ...
      var operation = 'bond_trade_details';
      ...
      if (fromDate1Fld > toDate1Fld) {
        hideloading();
        $("#f_dateErr").html("To date should be greater than From date");
        return false;
      }
