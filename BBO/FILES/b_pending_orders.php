        ...
        <div class="box">
            ...
            <div class="box-body table-responsive">
              ...
              <table id="pen_odr_tbl_id" class="table table-bordered table-striped" width="100%">
                ...
                <?php  
                  $stmt = $dbh->prepare("
                      SELECT a.id AS order_id, a.cd_code, a.participant_code, a.member_broker, a.order_size, a.order_entry, a.flag_id, a.sell_vol, a.buy_vol, a.price, a.side, a.commis_amt, a.order_date, a.acc_intrt, a.dirty_price, a.ytm, b.symbol, b.symbol_id, b.security_type 
                      FROM bond_orders a
                  ...
                  foreach ($rows as $res) {
                    ...
                    <tr style="background-color:' . $background_color . '">
                      ...
                      <td>' . $res['cd_code'] . '</td>
                      <td>' . $side . '</td>
                      <td><input type="number" class="form-control" size="5" value="' . $res['price'] . '" id="new_price' . $i . '"></td>
...
<script>
    ...
    function change_order(id) {
        ...
        if (payload.new_vol <= 0 || payload.new_vol % 10 !== 0) {
          $("#message").html("<div class='alert alert-warning alert-dismissible'>Volume should be a multiple of 10</div>");
          showMessage();
          return;
        }
        ...
        if (confirm("Do you want to continue updating order of " + payload.cd_code + "? The order will execute immediately if the price matches.")) {
            $.ajax({
              type: "POST",
