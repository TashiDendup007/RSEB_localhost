      ...
      <section class="content"><div class="modal fade" id="myModal" role="dialog"></div>
        <div class="box">
          ...
          <div class="box-footer">
            <div class="col-lg-6 col-md-6">          
              <button type="button"  class="btn btn-success" id="rightsaudit" name="rightsaudit"><i class="fa fa-bars"></i>  Generate </button>
            </div>
          </div>
          <div id="details"></div>   
         </div>      
...
<script type="text/javascript">
  ...
  $('#rightsaudit').click(function(){
    ...
    $.ajax({
      type: "POST",
      url: "rights_load.php",
      data: 'toDate='+toDate +'&fromDate='+fromDate +'&rightsaudit='+ op,
      success: function(data){
        hideloading();
