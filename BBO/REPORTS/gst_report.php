      ...
      <section class="content"><div class="modal fade" id="myModal" role="dialog"></div>
        <div class="box">
          <div class="box-header with-border">
            <h4 class="box-title">GST Report</h4>
          ...
          <div class="box-footer">
            <div class="col-lg-4 col-md-4">          
              <button type="button" class="btn btn-success" id="generate_report" name="generate_report"><i class="fa fa-bars"></i> Generate </button>
            </div>
          </div>
        <div id="details"></div>
        </div>
...
<script type="text/javascript">
  $('#generate_report').click( function() {
    ...
    var operation = 'generate_gst_report';
