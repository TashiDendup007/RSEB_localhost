<?php
	...
	if (isset($_POST['calculate_yield_to_maturity'])) {
		...
		// error_log($accrued);
		// error_log($dirtyPrice);
		// error_log(print_r($flows, true));
		// error_log($ytm);
		...
		$response = [
		    ...
		    'data' => [
		        ...
		        'commission' => ($commission > 0) ? number_format($commission, 2, '.', '') : 'No matching commission',
		    ]
		];
