        ...
        <div class="col-lg-12">
          <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">BLA mCaMS Wallet</h4>
            ...
            <div class="box-body">
              ...
              <div class="row">
                <div class="col-lg-6 col-md-6">
                  ...
                  <select name="report_type" id="report_type" class="form-control" onchange="report_type(this.value);" required>
                    <option value="">--Select--</option>
                    <option value="A">Individual</option>
                    <option value="B">Overall</option>
                  </select>
                </div>

                <div class="col-lg-6 col-md-6" id="cd_div_id">
                  <label>CD Code <font color="red">*</font></label>
                  <input type="cd_code" name="cd_code" id="cd_code" class="form-control" required>
                </div>
              </div>
            ...
            <div class="box-footer">
              <div class="col-lg-6 col-md-6">          
                <button type="button" class="btn btn-success" id="generate_bla_id" name="generate_bla_id"><i class="fa fa-tasks"></i> Generate</button>
              </div>
            </div>
...
<script type="text/javascript">
  ...
  $('#generate_bla_id').click( function() {
    showLoading();
    const report_ty = $("#report_type").val();
    const fromDate = $("#fromDate").val();
    const toDate   = $("#toDate").val();
    const op = 'generate_mcmas_wallet';
    const cd_code = (report_ty === 'A') ? $("#cd_code").val().trim() : '';
    ...
    $.ajax({
      ...
      data: { fromDate: fromDate, toDate: toDate, generate_mcmas_wallet: op, cd_code: cd_code, report_ty: report_ty },
      dataType: "html",
