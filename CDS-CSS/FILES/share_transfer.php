            ...
            <div class="box-body">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 has-warning">
                   <label class="control-label" for="inputWarning">From Account</label>
                    <input type="text" class="form-control" maxlength="10" name="F_cd" id="F_cd" onChange="getState2(this.value);" placeholder="Enter CD CODE" required>
                  </div>
                  <div id="cd"></div>
                </div>
            </div>
...
$("#transfer").click( function () {
  ...
  var operation = "share__transfer__submit";
  var dataString = 'F_cd='+ fromCd +'&T_cd='+ toCd + '&sy='+ symbol + '&remarks='+ remarks + '&trs='+ trsVol + '&userName='+ userName + '&share__transfer__submit='+ operation;
