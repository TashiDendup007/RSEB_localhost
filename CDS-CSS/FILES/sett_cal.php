      ...
      <div class="box">
        ...
        <form action="../PROCESS/process.php" method="post" onsubmit="showLoading();">
          ...
          <div class="box-footer">
            <div class="col-lg-6 col-md-6">
              <button type="submit" class="btn btn-success" id="save_sett" name="save_sett" value="<?php echo $_SESSION['sess_username'];?>"><i class="fa fa-plus"></i>  Save </button> 
            </div>
          </div>
        </form>
      </div>
        ...
        <div class="col-lg-12">
          <div class="box">
            <div class="box-header" style="font:8px;">
              <h4 class="box-title">List of Settlement Calendar</h4>
            </div>
            <div class="box-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php 
                    ...
                    while ($result=$query->fetch(PDO::FETCH_ASSOC)) {
                      ...
                      <tr>
                        <td> '.$i++.'</td>
                        <td> <input type="text"  class="form-control" value="'.$result['name'].'" name="name" id="name'.$result['sett_id'].'"></td>
                        <td> <input type="text" size="9" class="form-control" value="'.$result['days'].'" name="days" id="days'.$result['sett_id'].'"></td>
                        <td><button type="button" class="btn btn-success btnpress" name="edit_set" id="'.$result['sett_id'].'"><i class="fa fa-edit"></i> Update</button></td>
                      </tr>';
                      }
                    $query->closeCursor();
                  ?>
