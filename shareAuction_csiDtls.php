			...
			<div class="col-sm-8">
				...
				<form action="process/loadCSI.php" method="POST" class="form-horizontal" id="csiFormId" style="font-size: 12px;">
					<div class="form-group row">
				    	<div class="col-md-12">
				    		<label for="cid">Citizenship Identification Number</label>
				    		<input type="number" class="form-control" name="cid" id="cid" minlength="11" maxlength="11" pattern="/^-?\d+\.?\d*$/"
				    		 onKeyPress="if(this.value.length==11) return false;" placeholder="Enter CID Number" required>
				    	</div>
				  	</div>
					<div class="form-group row">
						<div class="col-sm-12 text-center"><br>
							<button type="button" class="btn btn-primary btn-lg" name="getCSIDetails" id="getCSIDetails">Search Details</button>&nbsp;&nbsp;
						</div>
					</div>
				</form>
			</div>
...
<script type="text/javascript">
	$("#getCSIDetails").click(function(){
		...
		$.ajax({
			type: "POST",
				url: "process/searchCSI.php",
				data:'cidNo='+cidNo+'&loadDetails='+op,
