    ...
    <section class="content"><div class="modal fade" id="myModal" role="dialog"></div>
      <div class="box">
        <div class="box-header with-border">
          <h4 class="box-title">IPO Subscription</h4>
        ...
        <div class="box-footer">
            <div class=" col-lg-6 col-md-6">          
              <button type="button" class="btn btn-success" id="subscription" name="subscription"><i class="fa fa-list"></i>  Generate </button>
            </div>
        </div>
        <div id="details"></div> 
      </div>
...
<script type="text/javascript">
  ...
  $('#subscription').click( function() {
    ...
    $.ajax({
      type: "POST",
      url: "ipo_load.php",
      data: 'toDate1='+toDate1 +'&fromDate1='+fromDate1 +'&subscription='+ trade_confirmation+'&cdcode='+cdcode,
      dataType: "html",
