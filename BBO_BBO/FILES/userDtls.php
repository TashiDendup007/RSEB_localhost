        ...
        <div class="box">
          ...
          <div class="box-body">
            <div class="box-body">
              <div class="row">
                <?php 
                  $sql = $dbh->prepare("SELECT a.cid, a.name, a.phone, a.email, a.participant_code, a.cd_code, a.address 
                    FROM api_online_terminal a 
                    WHERE a.user_online_id=:uId AND a.status='SUB'
                  ");
                  ...
                  <div class="col-lg-4 col-md-4">
                    ...
                    <span style="color: red;">Please make sure the email is correct</span>
                  </div>
                  <div class="col-lg-4 col-md-4">
          ...
          <div class="box-footer">
            <div class="col-lg-4">
              <button type="submit" class="btn btn-success btn-lg" id="brokerVerify" name="brokerVerify" value="BV"><i class="fa fa-check"></i> Verify</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <!-- <button type="submit" class="btn btn-danger btn-lg" id="brokerVerify" name="brokerVerify" value="B_REJ"> Reject</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; -->
              <button type="button" class="btn btn-warning btn-lg" onclick="returnBack();"><i class="fa fa-close"></i> Cancel</button>
            </div>
          </div>
          </form><br>
        </div>
