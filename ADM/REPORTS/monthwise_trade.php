      ...
      <section class="content">
        ...
        <div class="box">
          <div class="box-header with-border">
            <h4 class="box-title">Trade Volume - Month Wise</h4>
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div id="buttonId" style="display: none;">
                  &emsp;&ensp;
                  <a href="#" class="" onClick ="$('#tableListId').tableExport({type:'excel',escape:'false',fileName:'MonthWiseReport'});">
                    <button class="btn btn-success" type="button"> Excel</button></a>
                  <p><span style="color: red;">NOTE:</span> Click on Excel button to download</p>
                </div>
              </div>
            </div>
          </div>
...
<script type="text/javascript"> 
  $("#get_report_dtls").on("click", function() {
    ...
    var data = {
      ...
      get_monthwise_trade_dtls: "get_monthwise_trade_dtls"
    };
  ...
  function doExport(selector, params) {
    var options={
      ...
      worksheetName: 'MonthWiseReport',
      fileName: 'MonthWiseReport'
    };
