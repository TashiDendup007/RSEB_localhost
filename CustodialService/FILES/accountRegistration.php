    ...
    <section class="content">
      ...
      <div class="box">
          ...
          <div class="box-body">
            <div class="row">  
              ...
              <div class="col-xs-4">
                ...
                <input type="text" class="form-control" name="cdCode" id="cdCode" maxlength="10" value="<?php echo $newCdCode; ?>" readonly>
              </div>
              <div class="col-xs-4">
              ...
              <div class="col-xs-4">
                <label>TPN No</label>
                <input type="text" class="form-control" name="tpnNo" id="tpnNo">
              </div>
              <div class="col-xs-4">
        ...
        <div class="box-footer">
          <div class="col-xs-4">
              <button type="submit" class="btn btn-primary" style="" id="save_custodial_cc" name="save_custodial_cc" value="<?php echo $_SESSION['sess_username'];?>"><i class="fa fa-align-justify"></i> SAVE</button>
          </div>
        </div>
        </form>
        <div class="row">
